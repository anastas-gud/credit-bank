...
public class CalculatorService {
    ...
    public CreditDto calculateCredit(ScoringDataDto scoringData) {
        ...
        if (scoringData.getIsInsuranceEnabled()) {     //todo сумма страховки выплачивается за весь период или каждый год?
            BigDecimal insuranceCost = creditAmount     //todo и в целом стоимость страховки идет за год?
                    .multiply(config.getInsuranceCostPercent())     //то есть 300к на 12 месяцев - это 9к страховки
                    .divide(BigDecimal.valueOf(100), 2, RoundingMode.HALF_UP);     //и 300к на 6 месяцев - это 9к страховки
